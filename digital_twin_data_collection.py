...
MODE = 'collect-data'
WAYPOINTS_PER_EPISODE = 1000
TOTAL_EPISODES = 1
WAYPOINT_MAX_XY_COORDINATES = 150
WAYPOINT_MIN_XY_COORDINATES = 0
MAX_TIME_PER_EPISODE = 360000 # seconds
WIND_SPEED_SET = 5
SEED = 25
CURRENTDIR = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
CSV_FILE_NAME = '/digitaltwin_data_1000waypoints_1ep_wind5_maxcoord150'
...
class DigitalTwinDataCollection():
            ...
            try:
                ...
                while self._episode_counter <= TOTAL_EPISODES:
                    ...
                    for waypoint in self._all_episode_waypoint_lst[self._episode_counter-1]:
                        ...
                        self._waypoint_counter = self._waypoint_counter + 1
    ...
    def collect_data(self):
        ...
        self._waypoint_counter_lst.append(self._waypoint_counter)
    ...
    def create_data_structures(self):
        ...
        self._collected_data_dict = {
            ...
            'waypoint_counter': self._waypoint_counter_lst
        }
